...
const routes = [
  ["/", ["粤语鲜活学堂", "一步一步说到自然", "即时粤语", "输入原文直读", "换一种说法", "YOUR ROUTE / 学习顺序", "复习中心"]],
  ...
  ["/bridge", ["普通话转换桥", "读法顺序", "多个代表例子", "同字异读", "听音选词", "應承", "16", "saang1"]],
  ["/practice", ["立即反应", "自然粤语怎么说", "普通话迁移", "主动回忆"]],
  ["/review", ["复习中心", "现在该复习什么", "三种复习动作", "主动回忆", "听力辨认", "场景回放", "待复习", "显示粤语答案"]],
  ["/culture", ["香港口语与文化", "只听懂，不乱用", "538", "日常口语", "茶记与街市", "俗语与歇后语", "委婉与禁忌", "粤典", "香港大学研究", "中大普通话—粤语对照库", "香港电台 2025 潮语专题", "敏感用语", "我的学习状态", "显示已会词条", "标记已会", "清除已会记录"]],
];
