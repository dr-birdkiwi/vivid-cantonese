...
export default function PracticePage() {
  ...
  return (
    <main className="subpage practice-page">
      ...
      <section className="practice-method page-shell"><p className="eyebrow">WHY THIS ORDER / 为什么这样练</p><p>先从普通话意义主动回忆，再听粤语选项，最后看粤拼和解释。答错会缩短下一次复习间隔，答对会逐步拉长。</p><a href={sitePath("/review")}>去复习中心查看安排 →</a></section>
    </main>
  );
}
